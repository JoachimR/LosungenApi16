...
data class DailyLosung(
    override val language: String,
    val holiday: String,
    val year: Int,
    val dayOfYear: Int,
    val bibleTextPair: BibleTextPair
) : Losung() {
...
data class WeeklyLosung(
    ...
    override val bibleText: BibleText
) : SingleTextLosung(language) {
