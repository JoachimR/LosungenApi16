...
class WeeklyLosungDialog : LosungDialog<WeeklyLosungViewModel>() {

    companion object {

        fun createInstance() = WeeklyLosungDialog()
    ...
    override fun initViewModelObservers() {
        viewModel.losungLiveData().observe(this, Observer<AsyncLoad<WeeklyLosung?>> {
            updateUi()
        })
    }
