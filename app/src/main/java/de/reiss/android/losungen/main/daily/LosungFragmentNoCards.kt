...
import de.reiss.android.losungen.databinding.LosungFragmentNoCardsBinding
...
class LosungFragmentNoCards :
    AppFragment<LosungFragmentNoCardsBinding, LosungViewModel>(R.layout.losung_fragment_no_cards) {
    ...
    override fun inflateViewBinding(inflater: LayoutInflater, container: ViewGroup?) =
        LosungFragmentNoCardsBinding.inflate(inflater, container, false)
    ...
    fun setFontColor(fontColor: Int) {
        binding.content.losungNoteDivider.setBackgroundColor(fontColor)
        binding.content.losungNoteEdit.setColorFilter(
            fontColor,
