...
object Converter {
    ...
    fun itemToDailyLosung(language: String,
                          item: DailyLosungDatabaseItem?) =
            item?.let {
                val calendar = Calendar.getInstance().apply {
                    timeInMillis = it.date.time
                }
                DailyLosung(language = language,
                        holiday = it.holiday,
    ...
    fun itemToWeeklyLosung(language: String,
            ...
            item?.let {
                ...
                WeeklyLosung(language = language,
                        holiday = it.holiday,
    ...
    fun itemToMonthlyLosung(language: String,
                            item: MonthlyLosungDatabaseItem?) =
            item?.let {
                val startCalendar = Calendar.getInstance().apply {
                    timeInMillis = it.date.time
                }
                MonthlyLosung(language = language,
    ...
    fun itemToYearlyLosung(language: String,
                           item: YearlyLosungDatabaseItem?) =
            item?.let {
                YearlyLosung(language = language,
